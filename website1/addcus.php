...
<div class="row">
  <center>
   <h1><?php  
        echo "Welcome User"."  "."<center><p style='color:blue;'>".$_SESSION["id"]."</h2></center>";
       }
      ?>
   </h1>
  </center>
...
<div class="container">
  <div class="row1">
  <table  style="margin: 100px 100px 100px 100px; border-bottom-color: black;">
   <?php
       
     $qq="select car_ph,car_name,car_price,a_name,admin.a_id,car_id from car_details,admin where car_details.a_id = admin.a_id";
    ...
    <tr> 
     <div style="padding: 5px 5px 5px 5px;">
      <?php echo "<img src='$r[0]' width='100',height='100'>";?><br>
      Name : <?php echo $r[1];?><br>
      Price : <?php echo $r[2];?><br>
      Seller : <?php echo $r[3];?><br>
     <div class="buy"><a class="b" href='cart.php?<?php echo "c_id={$r[5]}"?>'>DETAILS</a></div>
     <div style="border: 1px solid black; margin : 10px 10px 10px 10px;"><hr></div>
     </div>
    </tr> 
 <?php
    }
