...
<?php
          $al=$_GET["c_id"];
     $qq="select car_ph,car_name,car_price,car_detail,a_name,admin.a_id,car_id from car_details,admin where car_details.a_id = admin.a_id and car_id=$al";
    ...
    { 
?>
<div class="sm-container single-car" style="padding: 0px 0px 0px 0px;">
 <div class="row" style="border-style: none; padding: 0px 0px 0px 0px; margin-top :0px;" >  
   <div class="col-2" style="margin :0px 0px 0px 0px; padding: 0px 0px 0px 0px; border-style: none;">
     <?php echo "<img src='$re[0]'/>";?>
   </div>
   <div class="col-2" style="margin-top:0px;">  
    <h1 style="margin: 0px 0px 0px 0px; padding: none;"><?php echo $re[1];?></h1>
    <h4 style="margin-top: 0px; margin-bottom: 0px;">$<?php echo $re[2]?></h4>
    <div class="buy" style="margin: 0px 0px 0px 0px;"><a class="b" href='payment.php?<?php echo "a_id={$re[5]}&c_id={$re[6]}";?>'>BUY</a></div>
