...
<div class="container">
  <div class="row1">
   <?php
     ...
     $qq="select cus_id,cus_name,cus_lname,cus_address,city_name,gender,email,phone_no,user_id,password,con_password from customer,cus_city where customer.city_id=cus_city.city_id and  user_id='".$_SESSION['id']."'";
    ...
    ?>
     ...
     <div style=" display: inline-block; border:2px solid black; background-color:black;">
      <table class="noman" style="margin: 2px 2px 2px 2px;padding: 10px 10px 10px 10px; border:2px solid black; background-color:rgba(200,240,240,0.8);" border="2">
      <tr>
        <th colspan="2">ACCOUNT  USER  INFORMATION</th>
      </tr>  
      <tr>  
       <td>ID:</td> 
       <td><?php echo $r[0];?></td>
      ...
      <tr>
       <td colspan="2" align="center"><a href="" style="color:black;">MODIFY <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
      </tr>
      </table>  
     </div>
     </center>
